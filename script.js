...
btn.addEventListener('click', () => {
    alert('Так, не пʼєш пиво? Можливо, ти просто екстремальний дегустатор безалкогольних напоїв і шукаєш адреналін у чистій воді? Відмова не приймається) Швиденько пиши де і коли зустрітись хочеш');
});
